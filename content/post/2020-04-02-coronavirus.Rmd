...
一つ目の図は感染者数累計の推移であり、アメリカ、イタリア、スペイン、ドイツは中国を超えており、その趨勢はピークに至っていないと理解できる。二つ目は、感染者数を対数変換した図である。日付 $t$ 、感染者数 $y_t$ について$y=\alpha\exp(\beta t)$ を当てはめることが許されれば、 $\log y_t=\log \alpha+\beta t$ と変換できる。この$\beta$は増加率を表す。三つ目はsmoothing処理（データのギザギザを取り、滑らかにする）を施した同様の図である。各国の折れ線の傾きが $\beta$の値であり、この傾き（増加率の仮の指標）からおよその感染率（既存の感染者数と新規感染者数との比率）を読み取るならば、国毎の感染率は概ね近い値であると理解できる。また、イタリア、イランの傾きは他国より小さくなる傾向が見られることから、両国の感染拡大は収まりつつあるとも理解できる。
...
一つ目の図は、新規感染者の推移である。3月以降、ヨーロッパで感染拡大が始まり、3月半ばからアメリカで急激に拡大した。二つ目はsmoothing処理（データのギザギザを取り、滑らかにする）を施した同様の図である。イタリアでは、3月後半にピークが来た可能性が高い。
...
二つ目の図は、回復確率の推移である。判断にはより長期のパネルデータが必要であるが、80パーセントの回復率という目安には疑いがもたれる。
